...
class DelayDrillTest(TestCase):
    ...
    def test_activity_create(self):
        project_obj = Project.objects.create(name='Sample Project1',start_date='2016-02-10',
                end_date='2018-03-20',total_budget='20000',budget_type=2,
                content_type=ContentType.objects.get(model='program'),object_id=0)
        ...
        for i in task_lists:
            ...
            self.assertIsNOtNOne(i.expected_end_date)
