...
DEFAULT_CONFIG = {
    ...
    'toolbar_Full': [
        ['Styles', 'Format', 'Font', 'FontSize', 'Bold', 'Italic', 'Underline', 'Strike', 'SpellChecker', 'Undo', 'Redo', 'JustifyLeft','JustifyCenter', 'JustifyRight', 'JustifyBlock', 'BidiLtr','BidiRtl', 'Blockquote', 'Smiley', 'SpecialChar', 'Print','Preview'],
        ['Image', 'Flash', 'Table', 'HorizontalRule', 'Link', 'Anchor', 'RemoveFormat', 'Templates', 'PasteFromWord', 'Scayt'],
        ['TextColor', 'BGColor','NumberedList', 'BulletedList', 'Select', 'Subscript', 'Superscript', 'Indent', 'Outdent'],
        ['Source'],
    ],
    'toolbar': 'Full',
    'height': 291,
